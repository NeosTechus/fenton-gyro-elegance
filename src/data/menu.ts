...
const gyroSaladProtein: ModifierGroup = {
  id: "gyro-salad-protein",
  label: "Protein",
  required: true,
  maxSelect: 1,
  options: [
    { id: "gyro", name: "Gyro slices", price: 0 },
    { id: "chicken", name: "Grilled chicken", price: 0 },
    { id: "chicken-salad", name: "Chicken salad (grilled chicken)", price: 0 },
  ],
};

const medSaladAddProtein: ModifierGroup = {
  id: "med-salad-protein",
  label: "Add protein (optional)",
  required: false,
  maxSelect: 1,
  options: [
    { id: "add-chicken", name: "Add grilled chicken", price: 3.99 },
    { id: "add-gyro", name: "Add gyro meat", price: 3.99 },
  ],
};

const butteredChickenPita: ModifierGroup = {
  id: "buttered-chicken-pita",
  label: "Add pita (optional)",
  required: false,
  maxSelect: 1,
...
const drinkChoice: ModifierGroup = {
  ...
  options: [
    ...
    { id: "ginger-beer", name: "Ginger Beer", price: 1.0 },
  ],
};
...
export const menuItems: MenuItem[] = [
  ...
  { id: "chicken-gyro-sub", name: "Chicken Gyro Sub", desc: "Grilled chicken, lettuce, tomatoes, red onion & feta cheese on french bread with tzatziki", price: 10.99, category: "Gyros", image: foodGreekSub, tag: "New", modifiers: [toppings, removeIngredients, doubleMeat, makeItCombo], allergens: ["wheat", "dairy"] },
  ...
  { id: "bag-pita-bread", name: "Bag of Pita Bread", desc: "Bag of fresh pita bread", price: 11.99, category: "Sides", image: foodPitaBread, allergens: ["wheat"], vegetarian: true },
  { id: "tzatziki-8oz", name: "8oz Tzatziki Sauce (no pita)", desc: "8oz container of housemade tzatziki only", price: 5.99, category: "Sides", image: foodTzatziki, allergens: ["dairy"], vegetarian: true },
  { id: "feta-8oz", name: "8oz Feta Cheese", desc: "8oz feta", price: 7.99, category: "Sides", image: foodGreekFries, allergens: ["dairy"], vegetarian: true },
  { id: "half-lb-gyro", name: "1/2 lb Gyro Meat", desc: "Half pound gyro slices", price: 7.99, category: "Sides", image: foodGyro, allergens: ["dairy"] },
  { id: "chicken-gyro-1lb", name: "1 lb Chicken Gyro", desc: "One pound grilled chicken gyro style", price: 14.99, category: "Sides", image: foodChickenGyro, allergens: ["dairy"] },
  ...
  { id: "chicken-tenders", name: "Chicken Tenders", desc: "Strips of white meat chicken, breaded and fried to a crispy golden brown & served with fries", price: 9.99, category: "Kids", image: foodChickenTenders, modifiers: [removeIngredients], allergens: ["wheat", "eggs"] },
  ...
  { id: "tiramisu-tray", name: "Tray of Tiramisu", desc: "Full tray of tiramisu", price: 47.99, category: "Desserts", image: foodTiramisu, allergens: ["wheat", "dairy", "eggs"], vegetarian: true },
  { id: "chocolate-baklava", name: "Chocolate Baklava", desc: "Baklava with chocolate", price: 4.99, category: "Desserts", image: foodBaklava, allergens: ["wheat", "tree-nuts"], vegetarian: true },
  { id: "ny-cheesecake", name: "New York Style Cheesecake", desc: "Classic NY-style cheesecake slice", price: 3.99, category: "Desserts", image: foodChocolateCake, allergens: ["wheat", "dairy", "eggs"], vegetarian: true },
  ...
  { id: "ginger-beer", name: "Ginger Beer", desc: "Refreshing ginger beer", price: 3.49, category: "Drinks", image: foodGingerBeer, vegetarian: true },
  { id: "bottle-unsweetened", name: "Bottle (Unsweetened)", desc: "Unsweetened bottled drink", price: 1.0, category: "Drinks", image: foodSoda, vegetarian: true },
  { id: "bottle-water", name: "Bottle Water", desc: "Bottled water", price: 1.99, category: "Drinks", image: foodAyran, vegetarian: true },
